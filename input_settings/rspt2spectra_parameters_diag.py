...
rspt2spectra_parameters_diag
============================

This file contains material specific information needed by
the finiteH0_diag.py script. Put this file in the RSPt simulation folder.
Then execute the finiteH0_diag.py script (which will read this file).
...
# Example with thirty (40+0) bath orbitals per impurity orbital
# wborder = get_wborders(n_val=40, n_con=0)


# Method of choice for selecting on-site energies.
# Four options:
# 0 - Read RSPt's diagonal on-site energies from the out-file.
#     This is the best option if an energy window is used
#     in RSPt's green.inp file.
